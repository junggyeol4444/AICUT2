...
export const api = {
  ...
  understanding: projectId => request(`/projects/${projectId}/understanding`),
  assembleUnderstanding: (projectId, payload) => request(`/projects/${projectId}/understanding`, {
    method: 'POST', body: JSON.stringify(payload),
  }),
  discover: (projectId, payload) => request(`/projects/${projectId}/discover`, {
    method: 'POST', body: JSON.stringify(payload),
  }),
  plan: (projectId, payload) => request(`/projects/${projectId}/plan`, {
    method: 'POST', body: JSON.stringify(payload),
  }),
